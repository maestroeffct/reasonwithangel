...
@section('content')
                    ...
                    <div class="card">
                        ...
                        <div class="card-header justify-content-between">
                            ...
                            <div class="d-flex align-items-center gap-12">
                                   <a href="{{ getAdminPanelUrl("/financial/installments/overdue/export") }}" class="btn bg-white bg-hover-gray-100 border-gray-400 text-gray-500">
    ...
    <div class="btn-group dropdown table-actions position-relative">
        ...
        <div class="dropdown-menu dropdown-menu-right webinars-lists-dropdown">
