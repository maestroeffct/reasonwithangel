                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        @if($order->status == \App\Models\ProductOrder::$waitingDelivery)
                                                            @can('admin_store_products_orders_tracking_code')
                                                                <a class="js-enter-tracking-code dropdown-item d-flex align-items-center mb-3 py-3 px-0 gap-4">
                                                                    <x-iconsax-lin-map class="icons text-gray-500 mr-2" width="18px" height="18px"/>
                                                                    <span class="text-gray-500 font-14">{{ trans('update.enter_tracking_code') }}</span>
                                                                </a>
                                                            @endcan
                                                        @endif
