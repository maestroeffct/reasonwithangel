                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="js-discounts-field form-group {{ (!empty($rule) and $rule->action == "send_coupon") ? '' : 'd-none' }}">
                                            ...
                                            <div class="text-gray-500 text-small mt-1">{{ trans('update.abandoned_cart_coupon_hint') }}</div>
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            ...
                                            <div class="text-gray-500 text-small mt-1">{{ trans('update.abandoned_cart_repeat_action_hint') }}</div>
                                        </div>
                                        ...
                                        <div class="js-repeat-action-count-field form-group {{ (!empty($rule) and $rule->repeat_action) ? '' : 'd-none' }}">
                                            ...
                                            <div class="text-gray-500 text-small mt-1">{{ trans('update.abandoned_cart_repeat_action_count_hint') }}</div>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="text-gray-500 text-small mt-1">{{ trans('update.abandoned_cart_rule_users_hint') }}</div>
                                            @error('users_ids')
                                            <div class="invalid-feedback d-block">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="text-gray-500 text-small mt-1">{{ trans('update.abandoned_cart_rule_user_groups_hint') }}</div>
                                            @error('group_ids')
                                            <div class="invalid-feedback d-block">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            ...
                                            <div class="text-gray-500 text-small mt-1">{{ trans('update.abandoned_cart_rule_enable_hint') }}</div>
                                        </div>
...
@push('scripts_bottom')
    <script src="/assets/admin/js/parts/abandoned_cart_rules.min.js"></script>
@endpush
